...
/**
 * A Chess Piece is represented as Integer value. This class offers constants
 * and static helper functions.
 */
public class Piece {
	...
	/**
	 * @param piece Integer representation of the piece
	 * @return String representation of a piece as used by FEN strings and the
	 *         console client
	 */
	...
	/**
	 * Builds the name of the piece according to the name of the graphic of the
	 * piece
	 * 
